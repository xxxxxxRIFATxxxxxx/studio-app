    ...
    return (
        <footer className="blue-bg">
            <div className="grid grid-cols-2 gap-8 py-4 md:grid-cols-4">
                <div>
                    <h2 className="mb-4 white-text heading-4">About</h2>
                    <ul className="text-gray-500 dark:text-gray-400">
                        <li className="mb-4">
                            <a className="white-text text-3">
                ...
                <div>
                    <h2 className="mb-4 white-text heading-4">Support</h2>
                    <ul className="text-gray-500 dark:text-gray-400">
                        <li className="mb-4">
                            <a className="white-text text-3">
                ...
                <div>
                    <h2 className="mb-4 white-text heading-4">FAQ</h2>
                    <ul className="text-gray-500 dark:text-gray-400">
                        <li className="mb-4">
                            <a className="white-text text-3">
                ...
                <div>
                    <h2 className="mb-4 white-text heading-4">Resource</h2>
                    <ul className="text-gray-500 dark:text-gray-400">
                        <li className="mb-4">
                            <a className="white-text text-3">
                                <Link href="/">Contact Us</Link>
            ...
            <div className="py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="https://flowbite.com/">Studio App</a>. All Rights Reserved.
                </span>
